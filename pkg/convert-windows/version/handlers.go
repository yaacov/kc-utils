...
func (win81) DriverOSPreferences() []string { return []string{"w8.1"} }
...
func (win8) DriverOSPreferences() []string { return []string{"w8"} }
...
func (win7) DriverOSPreferences() []string { return []string{"w7"} }
...
func (win2008r2) DriverOSPreferences() []string { return []string{"2k8r2"} }
...
func (winvista) DriverOSPreferences() []string { return []string{"vista"} }
...
func (win2003) DriverOSPreferences() []string { return []string{"2k3"} }
func (win2003) DriverOSFallbacks() []string   { return nil }
