...
func TestMatchOSVersionAliases(t *testing.T) {
	tests := []struct {
		...
		{dirVer: "w11", requested: "Windows Server 2022", shouldFind: false},
		{dirVer: "2k19", requested: "Windows Server 2019", shouldFind: true},
		{dirVer: "w10", requested: "Windows Server 2019", shouldFind: false},
		{dirVer: "w8.1", requested: "Windows Server 2019", shouldFind: false},
		{dirVer: "w7", requested: "6.1", shouldFind: false},
		{dirVer: "2k8r2", requested: "Windows 7", shouldFind: false},
		{dirVer: "2k8r2", requested: "Windows Server 2008 R2", shouldFind: true},
		{dirVer: "2k8", requested: "Windows Vista", shouldFind: false},
		{dirVer: "vista", requested: "Windows Server 2008", shouldFind: false},
		{dirVer: "2k8", requested: "Windows Server (R) 2008 Enterprise\x00", shouldFind: true},
	}
