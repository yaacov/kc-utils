...
| `apply.go` | Mounts specs in order, updates partition metadata, provides `SortSpecs` |
...
| `SortSpecs` | Returns a copy of specs sorted by guest mount path length |
