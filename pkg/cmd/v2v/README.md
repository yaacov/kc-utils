...
| Copy | `kc-copy` ([`pkg/copy/`](../../copy/)) | Optional NFC disk copy subprocess |
| Discover | [`pkg/v2v/env/disks.go`](../../v2v/env/disks.go) | Glob `/dev/blockN` and `/mnt/disks/...` |
| Metadata | [`pkg/v2v/env/sourcemeta.go`](../../v2v/env/sourcemeta.go) | NICs, firmware, hostname (govmomi for vSphere) |
| Pipeline | [`pipeline.go`](pipeline.go) | Spawn kc-copy → kc-prepare → converter → kc-finalize |
| Inspection | [`pkg/v2v/inspection/xml/`](../../v2v/inspection/xml/) | Write Forklift-compatible inspection XML |
